...
0006 and 0007 are applied to `work/vllm` at the pinned base (`a00a3544b93e`) and their anchors are recorded in the patch files; the rest are pending until their anchors are recorded at first cluster build.
